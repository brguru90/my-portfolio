...
class projects extends Component {
    ...
    generate_bg_img = (width, _length = 2) => {
        ...
        const img_height = (multiplier * _length) + 278
        ...
        const svg_img = (
            <svg width={`${vw}px`} height={`${img_height}px`} viewBox={`0 0 ${vw} ${img_height}`}
                ...
                <path
                    ...
                    d={`M1200,0 C1200,0 200,0 600,400 Q800,600 600,800 ${sequence} C600,${multiplier * _length} 400,${(multiplier * _length) + 200} 0,${(multiplier * _length) + 200} L0,${(multiplier * _length) + 200} L0,${(multiplier * _length) + 400} L1200,${(multiplier * _length) + 400} L1200,0 L600,0`}
                    fill={bg_color}
                // stroke="red"
                // stroke-width="5"
                />
